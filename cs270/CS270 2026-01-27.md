...
$$\text{Classification accuracy}=\frac{\text{num correct}}{\text{total instances}}$$
$$\text{Classification error}=\frac{\text{num misclassified}}{\text{total instances}}=1-\text{accuracy}$$
